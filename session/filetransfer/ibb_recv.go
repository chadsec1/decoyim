...
func IbbOpen(s decoylog.Has, stanza *data.ClientIQ) (ret interface{}, iqtype string, ignore bool) {
...
func ibbParseXMLData(s decoylog.Has, dt []byte) (tag data.IBBData, ctx *recvContext, ictx *ibbContext, ret interface{}, iqtype string, ignore bool) {
...
func ibbOnData(s decoylog.Has, body []byte) (ret interface{}, iqtype string, ignore bool) {
...
func IbbData(s decoylog.Has, stanza *data.ClientIQ) (interface{}, string, bool) {
...
func IbbMessageData(s decoylog.Has, stanza *data.ClientMessage, ext *data.Extension) {
	_, _, _ = ibbOnData(s, []byte(ext.Body))
}

// IbbClose is the hook function that will be called when we receive an ibb close IQ
func IbbClose(s decoylog.Has, stanza *data.ClientIQ) (ret interface{}, iqtype string, ignore bool) {
